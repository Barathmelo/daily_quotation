    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                Spacer()
                    .frame(height: 120) // Space for bottom tab bar
            }
        }
        .overlay(
            settingsOverlay,
                                    ...
                                    Text(font.displayName)
                                        ...
                                        .background(
                                            RoundedRectangle(cornerRadius: 8)
                                                .fill(appearance.font == font ? Color.white.opacity(0.2) : Color.white.opacity(0.1))
                                        )
                                }
                            }
                        }
                        ...
                        HStack(spacing: 8) {
                            ForEach(TextSize.allCases, id: \.self) { size in
                                Button(action: {
                                    ...
                                    Text("A")
                                        .font(.system(size: size == .small ? 12 : size == .medium ? 16 : 20, weight: .medium))
                                        .foregroundColor(appearance.size == size ? .white : .white.opacity(0.5))
                                        .frame(maxWidth: .infinity)
                                        .padding(.vertical, 8)
                                        .background(
                                            RoundedRectangle(cornerRadius: 8)
                                                .fill(appearance.size == size ? Color.white.opacity(0.2) : Color.white.opacity(0.1))
                                        )
                                }
                            }
                        }
